module.exports = {
	 ...
	 * data 请求参数 说明
	 * @params {Array} role_id 					角色Id（role_id）
	 * @params {Array} menuList 				菜单Id（menu_id）列表
	 * @params {Boolean} reset 					是否直接覆盖菜单，true：直接将menuList设置为角色菜单，false：在角色已有菜单后追加菜单
	 * @params {Boolean} addPermission	是否自动添加菜单内置的权限 默认false
	 * res 返回参数说明
